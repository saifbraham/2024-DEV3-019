...
class BookStoreTest {
    ...
    void testCalculateTotalPriceOfSingleSeriesPurchase() {
        ...
        assertEquals(100, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 3, 0, 0, 0, 0);
        assertEquals(150, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 0, 0, 0, 1, 0);
        assertEquals(50, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 0, 0, 0, 0, 0);
        assertEquals(0.0, store.calculatePriceless(basket.getQuantities()));
    ...
    void testCalculateTotalPriceTwoSeriesPurchase() {
        ...
        assertEquals(340, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 1, 0, 2, 0, 0);
        assertEquals(145, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 0, 2, 2, 0, 0);
        assertEquals(190, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 0, 1, 1, 0, 0);
        assertEquals(95, store.calculatePriceless(basket.getQuantities()));
    ...
    void testCalculateTotalPriceOfMaxThreeSeriesPurchase() {
        ...
        assertEquals(280, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 0, 1, 2, 0, 1);
        assertEquals(185, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 0, 2, 2, 0, 2);
        assertEquals(270, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 0, 1, 1, 0, 1);
        assertEquals(135, store.calculatePriceless(basket.getQuantities()));
    ...
    void testCalculateTotalPriceOfFourSeriesPurchase() {
        ...
        assertEquals(255, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 2, 2, 2, 1, 0);
        assertEquals(295, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 1, 1, 1, 1, 0);
        assertEquals(160, store.calculatePriceless(basket.getQuantities()));
        ...
        assertEquals(210, store.calculatePriceless(basket.getQuantities()));
    ...
    void testCalculateTotalPriceOfFiveSeriesPurchase() {
        ...
        assertEquals(320, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 1, 1, 1, 1, 1);
        assertEquals(187.5, store.calculatePriceless(basket.getQuantities()));

        basket.clear();
        addBooksToStore(basket, 1, 2, 1, 1, 1);
        assertEquals(237.5, store.calculatePriceless(basket.getQuantities()));
